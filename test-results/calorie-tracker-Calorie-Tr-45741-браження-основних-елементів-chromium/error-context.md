...
- Name: calorie-tracker.spec.js >> Calorie Tracker - Наскрізне тестування >> №1: Запуск додатку та відображення основних елементів
- Location: tests\e2e\calorie-tracker.spec.js:5:3
...
Locator: getByText('Calorie Tracker')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Calorie Tracker')
