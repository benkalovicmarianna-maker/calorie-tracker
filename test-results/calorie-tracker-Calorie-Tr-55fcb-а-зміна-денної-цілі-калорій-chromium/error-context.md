...
- Name: calorie-tracker.spec.js >> Calorie Tracker - Наскрізне тестування >> №3: Перегляд та зміна денної цілі калорій
- Location: tests\e2e\calorie-tracker.spec.js:50:3
