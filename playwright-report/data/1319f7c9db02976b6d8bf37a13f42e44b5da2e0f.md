...
- Name: calorie-tracker.spec.js >> Calorie Tracker - Наскрізне тестування >> №2: Додавання страви до щоденника
- Location: tests\e2e\calorie-tracker.spec.js:24:3
...
Call log:
  - waiting for getByRole('button', { name: /Food Log/i })
